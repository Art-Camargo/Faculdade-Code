...
void PrintMenu(){ // função que printa as opcoes do menu. É chamada no main a cada ciclo de programa.
	printf("\n1 - CADASTRAR CLIENTE");
...
void CadastraCliente(dados *cliente, FILE *arquivo_db){
	...
	printf("%s, Informe o nome da sua rua: ", cliente->nome);
